...
const seedData = async () => {
    try {
        ...
        const drivers = await Driver.insertMany([
            { organization: orgId, name: 'John Doe', phone: '+1234567890', licenseCategory: 'Class A', status: 'Available', safetyScore: 92 },
            { organization: orgId, name: 'Jane Smith', phone: '+0987654321', licenseCategory: 'Class B', status: 'On Trip', safetyScore: 88 },
        ]);
